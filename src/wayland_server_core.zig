        ...
        wl_display_set_global_filter(
            ...
            struct {
                fn _wrapper(_client: *const Client, _global: *const Global, _data: ?*anyopaque) callconv(.C) bool {
                    return filter(_client, _global, @alignCast(@ptrCast(_data)));
                }
            }._wrapper,
            data,
        );
...
pub const Resource = opaque {
    ...
    pub inline fn create(client: *Client, comptime T: type, version: u32, id: u32) error{ResourceCreateFailed}!*Resource {
        ...
        return wl_resource_create(client, T.getInterface(), @intCast(version), id) orelse error.ResourceCreateFailed;
    }
    ...
    pub fn getVersion(resource: *Resource) u32 {
        ...
        return @intCast(wl_resource_get_version(resource));
    }
